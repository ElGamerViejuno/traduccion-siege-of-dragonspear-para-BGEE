...
- La traducción ya deja de considerarse en un estado "BETA" y ya se puede considerar una traducción finalizada de gran calidad, aunque tratándose de un archivo con un total de 96197 líneas (juego base + expansión) siempre tarde o temprano se va descubrir algún nuevo error o alguna línea que se pueda mejorar. Por eso se continuará revisando la traducción ante cualquier error reportado o posible mejora que se pueda implementar.
