...
- (Experimental) Se ha restaurado el comando <PRO_RACE> en líneas tanto del juego base como la expansión SoD donde la versión original en inglés sí que lo incluye este comando. Las frases ingame con este comando nombran la raza y el género de tu personaje principal.
