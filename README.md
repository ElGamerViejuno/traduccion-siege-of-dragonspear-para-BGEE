...
- La traducción ya deja de considerarse en un estado "BETA" y ya se puede considerar una traducción finalizada de gran calidad, aunque tratándose de un archivo con un total de 96197 líneas (juego base + expansión) siempre se va descubrir algún error o línea que se pueda mejorar tarde o temprano. Por eso se continuará revisando la traducción ante cualquier error reportado o posible mejora que se pueda implementar.
