...
- Se han revisado textos de los conjuros del juego base y la expansión SoD. Detalles como los tiempos de lanzamiento o algunas otras características no estaban correctamente descritas, al compararse con las traducciones de los demas idiomas oficiales. Esto posiblemente se debiera a que muchos conjuros fueron siendo rebalanceados en las versiones "Enhanced Edition" y en la traducción de ClanDlan se habrían utilizado los textos de la versión original de BG1 sin ninguna actualización de textos adicional.
