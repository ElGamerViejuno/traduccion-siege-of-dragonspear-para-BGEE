...
- La traducción ya deja de considerarse en un estado "BETA" y se podría considerar una traducción finalizada de gran calidad, aunque tarde o temprano siempre puede que se descubra algún error o haya alguna línea que se pueda mejorar. Por eso se continuará revisando la traducción ante cualquier error reportado o posible mejora que se pueda implementar.
