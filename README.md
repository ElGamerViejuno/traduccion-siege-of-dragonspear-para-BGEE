...
- Se han borrado líneas repetidas para personajes femeninos que tenían exactamente los mismos textos que en su versión masculina en la traducción del juego base.
...
Recordad que esta traducción también contiene arreglos para el juego base (BGEE+SoD), se trata de un proyecto que no se debería considerar nunca al 100% finalizado, con nuevas revisiones cada cierto tiempo y atendiendo nuevos reportes de los jugadores.
